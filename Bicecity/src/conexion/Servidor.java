...
public class Servidor {
	...
	/**
	 * Bandera que indica el estado de la conexion para saber si esta o no ocupado
	 */
	...
	private Servidor() throws Exception {
                try {
                    ...
                    String url = "jdbc:postgresql://localhost:5432/BiceCity1";
                    String usuario = "postgres";
                    String password = "rdmon"; //Debe reemplazarse por el password en su propia instalación
                    Class.forName("org.postgresql.Driver").newInstance();
                    conexion = DriverManager.getConnection(url, usuario, password);
                    conexion.setAutoCommit(false);
                } catch (Exception e) {
                    throw new Excepcion("ServiceLocator", "ERROR_CONEXION_BD " + e);
                }
         }
